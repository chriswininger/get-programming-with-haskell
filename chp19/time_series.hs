...
-- run `makeTSCompare max (3,Just 200) (4,Just 10)`
...
-- the `Num a =>` part is defining the type parameter
...
-- run `meanTS (diffTS tsAll) to see mean change in sales over time
...
smoothed :: TS Double
smoothed = movingAverageTS tsAll 7
